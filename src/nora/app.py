...
anything else, explain that Nora only supports R and Stata.
...
researcher to inspect. The Nora environment does not restrict the \
...
def _scan_datasets(cwd: Path) -> list[Path]:
    ...
    Only the three formats Nora currently supports: ``.csv``,
