...
Stata (runtime on adopath):
  nora_result_regress, label("...")           # after regress/logit/probit/poisson/stcox/xtreg fe/areg/ivregress/mixed/meglm
  ...
  nora_result_km, horizons("1y:1 3y:3 5y:5 10y:10") time(<v>) event(<v>) [group(<v>)] label("...")
  nora_result_cluster <varlist>, clusvar(<v>) method("kmeans"|"hierarchical") [linkage("ward"|"complete"|...)] label("...")    # after cluster kmeans/wardslinkage/...
  nora_result_factor, method("pca"|"maximum_likelihood"|...) [rotation("varimax"|...)] label("...")    # after pca/factor
