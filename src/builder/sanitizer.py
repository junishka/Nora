"""Builder — sanitizer + runtime-library contract.
...
the Builder runtime library, and Builder passes that payload through
...
runtime-library contract. `builder$result(...)` in R and `builder_result`
